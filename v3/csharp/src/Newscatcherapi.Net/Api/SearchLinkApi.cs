...
namespace Newscatcherapi.Net.Api
{
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SearchLinkApi : ISearchLinkApi
    {
        private Newscatcherapi.Net.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="SearchLinkApi"/> class.
        /// </summary>
        /// <returns></returns>
        public SearchLinkApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public SearchLinkApi(string basePath)
        {
        ...
        /// <returns></returns>
        public SearchLinkApi(Newscatcherapi.Net.Client.Configuration configuration)
        {
        ...
        public SearchLinkApi(Newscatcherapi.Net.Client.ISynchronousClient client, Newscatcherapi.Net.Client.IAsynchronousClient asyncClient, Newscatcherapi.Net.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DtoResponsesSearchResponseSearchResponse)</returns>
        public async System.Threading.Tasks.Task<Newscatcherapi.Net.Client.ApiResponse<DtoResponsesSearchResponseSearchResponse>> PostWithHttpInfoAsync(SearchURLRequest searchURLRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'searchURLRequest' is set
            if (searchURLRequest == null)
            {
