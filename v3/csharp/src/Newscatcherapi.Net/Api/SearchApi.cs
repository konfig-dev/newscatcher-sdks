...
namespace Newscatcherapi.Net.Api
{
    ...
    public interface ISearchApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SearchGetResponse> GetAsync(string q, string searchIn = default(string), Object predefinedSources = default(Object), Object sources = default(Object), Object notSources = default(Object), Object lang = default(Object), Object notLang = default(Object), Object countries = default(Object), Object notCountries = default(Object), Object notAuthorName = default(Object), From from = default(From), To to = default(To), string publishedDatePrecision = default(string), bool? byParseDate = default(bool?), string sortBy = default(string), string rankedOnly = default(string), int? fromRank = default(int?), int? toRank = default(int?), bool? isHeadline = default(bool?), bool? isPaidContent = default(bool?), Object parentUrl = default(Object), Object allLinks = default(Object), Object allDomainLinks = default(Object), int? wordCountMin = default(int?), int? wordCountMax = default(int?), int? page = default(int?), int? pageSize = default(int?), string clusteringVariable = default(string), bool? clusteringEnabled = default(bool?), double? clusteringThreshold = default(double?), bool? includeNlpData = default(bool?), bool? hasNlp = default(bool?), string theme = default(string), string notTheme = default(string), string oRGEntityName = default(string), string pEREntityName = default(string), string lOCEntityName = default(string), string mISCEntityName = default(string), double? titleSentimentMin = default(double?), double? titleSentimentMax = default(double?), double? contentSentimentMin = default(double?), double? contentSentimentMax = default(double?), Object iptcTags = default(Object), Object notIptcTags = default(Object), Object sourceName = default(Object), Object iabTags = default(Object), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
