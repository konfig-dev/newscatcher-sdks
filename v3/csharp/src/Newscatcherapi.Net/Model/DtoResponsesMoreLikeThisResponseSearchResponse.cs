...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__more_like_this_response__SearchResponse")]
    public partial class DtoResponsesMoreLikeThisResponseSearchResponse : IEquatable<DtoResponsesMoreLikeThisResponseSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesMoreLikeThisResponseSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesMoreLikeThisResponseSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesMoreLikeThisResponseSearchResponse" /> class.
        /// </summary>
        ...
        public DtoResponsesMoreLikeThisResponseSearchResponse(string status = "ok", int totalHits = default(int), int page = default(int), int totalPages = default(int), int pageSize = default(int), List<Object> articles = default(List<Object>), Object userInput = default(Object))
        {
            ...
            if (articles == null)
            {
                throw new ArgumentNullException("articles is a required property for DtoResponsesMoreLikeThisResponseSearchResponse and cannot be null");
            }
            this.Articles = articles;
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for DtoResponsesMoreLikeThisResponseSearchResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as DtoResponsesMoreLikeThisResponseSearchResponse);
        }

        /// <summary>
        /// Returns true if DtoResponsesMoreLikeThisResponseSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesMoreLikeThisResponseSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesMoreLikeThisResponseSearchResponse input)
        {
            if (input == null)
            {
                return false;
