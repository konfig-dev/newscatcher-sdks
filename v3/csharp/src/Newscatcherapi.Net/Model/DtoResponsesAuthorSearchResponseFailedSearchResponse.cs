...
namespace Newscatcherapi.Net.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesAuthorSearchResponseFailedSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesAuthorSearchResponseFailedSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesAuthorSearchResponseFailedSearchResponse" /> class.
        /// </summary>
        ...
        public DtoResponsesAuthorSearchResponseFailedSearchResponse(string status = "No Matches for your search", int totalHits = 0, int page = 0, int totalPages = 0, int pageSize = 0, List<DtoResponsesAuthorSearchResponseArticleResult> articles = default(List<DtoResponsesAuthorSearchResponseArticleResult>), Object userInput = default(Object))
        {
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for DtoResponsesAuthorSearchResponseFailedSearchResponse and cannot be null");
            }
        ...
        public List<DtoResponsesAuthorSearchResponseArticleResult> Articles { get; set; }
        ...
        {
            return this.Equals(input as DtoResponsesAuthorSearchResponseFailedSearchResponse);
        }

        /// <summary>
        /// Returns true if DtoResponsesAuthorSearchResponseFailedSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesAuthorSearchResponseFailedSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesAuthorSearchResponseFailedSearchResponse input)
        {
            if (input == null)
            {
                return false;
