...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FailedLatestHeadlinesResponse")]
    public partial class FailedLatestHeadlinesResponse : IEquatable<FailedLatestHeadlinesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedLatestHeadlinesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FailedLatestHeadlinesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedLatestHeadlinesResponse" /> class.
        /// </summary>
        ...
        public FailedLatestHeadlinesResponse(string status = "No Matches for your search", int totalHits = 0, int page = 0, int totalPages = 0, int pageSize = 0, List<DtoResponsesLatestHeadlinesResponseArticleResult> articles = default(List<DtoResponsesLatestHeadlinesResponseArticleResult>), Object userInput = default(Object))
        {
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for FailedLatestHeadlinesResponse and cannot be null");
            }
        ...
        public List<DtoResponsesLatestHeadlinesResponseArticleResult> Articles { get; set; }
        ...
        {
            return this.Equals(input as FailedLatestHeadlinesResponse);
        }

        /// <summary>
        /// Returns true if FailedLatestHeadlinesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of FailedLatestHeadlinesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FailedLatestHeadlinesResponse input)
        {
            if (input == null)
            {
                return false;
