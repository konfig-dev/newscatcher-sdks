...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__LatestHeadlinesResponse__ArticleResult")]
    public partial class DtoResponsesLatestHeadlinesResponseArticleResult : IEquatable<DtoResponsesLatestHeadlinesResponseArticleResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesLatestHeadlinesResponseArticleResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesLatestHeadlinesResponseArticleResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesLatestHeadlinesResponseArticleResult" /> class.
        /// </summary>
        ...
        public DtoResponsesLatestHeadlinesResponseArticleResult(string title = default(string), string description = default(string), string author = default(string), AuthorsProperty authors = default(AuthorsProperty), JournalistsProperty journalists = default(JournalistsProperty), string publishedDate = default(string), string publishedDatePrecision = default(string), string updatedDate = default(string), string updatedDatePrecision = default(string), string parseDate = default(string), string link = default(string), string domainUrl = default(string), string fullDomainUrl = default(string), string nameSource = default(string), string isHeadline = default(string), bool paidContent = default(bool), string extractionData = default(string), string country = default(string), string rights = default(string), int rank = default(int), string media = default(string), string language = default(string), string content = default(string), int wordCount = 0, bool isOpinion = default(bool), string twitterAccount = default(string), AllLinksProperty allLinks = default(AllLinksProperty), AllDomainLinksProperty allDomainLinks = default(AllDomainLinksProperty), Object nlp = default(Object), string id = default(string), double score = default(double))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DtoResponsesLatestHeadlinesResponseArticleResult and cannot be null");
            }
            this.Id = id;
            this.Score = score;
        ...
        {
            return this.Equals(input as DtoResponsesLatestHeadlinesResponseArticleResult);
        }

        /// <summary>
        /// Returns true if DtoResponsesLatestHeadlinesResponseArticleResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesLatestHeadlinesResponseArticleResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesLatestHeadlinesResponseArticleResult input)
        {
            if (input == null)
            {
                return false;
