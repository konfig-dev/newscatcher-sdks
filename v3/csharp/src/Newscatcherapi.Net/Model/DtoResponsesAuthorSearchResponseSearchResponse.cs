...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__author_search_response__SearchResponse")]
    public partial class DtoResponsesAuthorSearchResponseSearchResponse : IEquatable<DtoResponsesAuthorSearchResponseSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesAuthorSearchResponseSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesAuthorSearchResponseSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesAuthorSearchResponseSearchResponse" /> class.
        /// </summary>
        ...
        public DtoResponsesAuthorSearchResponseSearchResponse(string status = "ok", int totalHits = default(int), int page = default(int), int totalPages = default(int), int pageSize = default(int), List<Object> articles = default(List<Object>), Object userInput = default(Object))
        {
            ...
            if (articles == null)
            {
                throw new ArgumentNullException("articles is a required property for DtoResponsesAuthorSearchResponseSearchResponse and cannot be null");
            }
            this.Articles = articles;
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for DtoResponsesAuthorSearchResponseSearchResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as DtoResponsesAuthorSearchResponseSearchResponse);
        }

        /// <summary>
        /// Returns true if DtoResponsesAuthorSearchResponseSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesAuthorSearchResponseSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesAuthorSearchResponseSearchResponse input)
        {
            if (input == null)
            {
                return false;
