...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__SearchResponse__ArticleResult")]
    public partial class DtoResponsesSearchResponseArticleResult : IEquatable<DtoResponsesSearchResponseArticleResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseArticleResult" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesSearchResponseArticleResult() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseArticleResult" /> class.
        /// </summary>
        ...
        public DtoResponsesSearchResponseArticleResult(string title = default(string), string description = default(string), string author = default(string), AuthorsProperty authors = default(AuthorsProperty), JournalistsProperty journalists = default(JournalistsProperty), string publishedDate = default(string), string publishedDatePrecision = default(string), string updatedDate = default(string), string updatedDatePrecision = default(string), string parseDate = default(string), string link = default(string), string domainUrl = default(string), string fullDomainUrl = default(string), string nameSource = default(string), string isHeadline = default(string), bool paidContent = default(bool), string extractionData = default(string), string country = default(string), string rights = default(string), int rank = default(int), string media = default(string), string language = default(string), string content = default(string), int wordCount = 0, bool isOpinion = default(bool), string twitterAccount = default(string), AllLinksProperty allLinks = default(AllLinksProperty), AllDomainLinksProperty allDomainLinks = default(AllDomainLinksProperty), Object nlp = default(Object), string id = default(string), double score = default(double))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for DtoResponsesSearchResponseArticleResult and cannot be null");
            }
            this.Id = id;
            this.Score = score;
        ...
        {
            return this.Equals(input as DtoResponsesSearchResponseArticleResult);
        }

        /// <summary>
        /// Returns true if DtoResponsesSearchResponseArticleResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesSearchResponseArticleResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesSearchResponseArticleResult input)
        {
            if (input == null)
            {
                return false;
