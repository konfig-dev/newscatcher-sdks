...
namespace Newscatcherapi.Net.Model
{
    ...
    public partial class ValidationError : IEquatable<ValidationError>, IValidatableObject
    {
        ...
        public ValidationError(List<LocationPropertyInner> loc = default(List<LocationPropertyInner>), string msg = default(string), string type = default(string))
        {
        ...
        public List<LocationPropertyInner> Loc { get; set; }
