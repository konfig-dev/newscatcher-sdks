...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClusteringSearchResponse")]
    public partial class ClusteringSearchResponse : IEquatable<ClusteringSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClusteringSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClusteringSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClusteringSearchResponse" /> class.
        /// </summary>
        ...
        /// <param name="clustersCount">clustersCount (required).</param>
        /// <param name="clusters">clusters (required).</param>
        /// <param name="userInput">userInput (required).</param>
        public ClusteringSearchResponse(string status = "ok", int totalHits = default(int), int page = default(int), int totalPages = default(int), int pageSize = default(int), int clustersCount = default(int), List<Cluster> clusters = default(List<Cluster>), Object userInput = default(Object))
        {
            ...
            if (clusters == null)
            {
                throw new ArgumentNullException("clusters is a required property for ClusteringSearchResponse and cannot be null");
            }
            this.Clusters = clusters;
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for ClusteringSearchResponse and cannot be null");
            }
        ...
        /// <summary>
        /// Gets or Sets ClustersCount
        /// </summary>
        [DataMember(Name = "clusters_count", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ClustersCount: ").Append(ClustersCount).Append("\n");
        ...
        {
            return this.Equals(input as ClusteringSearchResponse);
        }

        /// <summary>
        /// Returns true if ClusteringSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ClusteringSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClusteringSearchResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ClustersCount == input.ClustersCount ||
                    this.ClustersCount.Equals(input.ClustersCount)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.ClustersCount.GetHashCode();
