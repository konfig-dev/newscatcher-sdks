...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__search_response__SearchResponse")]
    public partial class DtoResponsesSearchResponseSearchResponse : IEquatable<DtoResponsesSearchResponseSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesSearchResponseSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseSearchResponse" /> class.
        /// </summary>
        ...
        public DtoResponsesSearchResponseSearchResponse(string status = "ok", int totalHits = default(int), int page = default(int), int totalPages = default(int), int pageSize = default(int), List<Object> articles = default(List<Object>), Object userInput = default(Object))
        {
            ...
            if (articles == null)
            {
                throw new ArgumentNullException("articles is a required property for DtoResponsesSearchResponseSearchResponse and cannot be null");
            }
            this.Articles = articles;
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for DtoResponsesSearchResponseSearchResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as DtoResponsesSearchResponseSearchResponse);
        }

        /// <summary>
        /// Returns true if DtoResponsesSearchResponseSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesSearchResponseSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesSearchResponseSearchResponse input)
        {
            if (input == null)
            {
                return false;
