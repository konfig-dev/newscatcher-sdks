...
namespace Newscatcherapi.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "dto__responses__SearchResponse__FailedSearchResponse")]
    public partial class DtoResponsesSearchResponseFailedSearchResponse : IEquatable<DtoResponsesSearchResponseFailedSearchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseFailedSearchResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DtoResponsesSearchResponseFailedSearchResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoResponsesSearchResponseFailedSearchResponse" /> class.
        /// </summary>
        ...
        public DtoResponsesSearchResponseFailedSearchResponse(string status = "No Matches for your search", int totalHits = 0, int page = 0, int totalPages = 0, int pageSize = 0, List<DtoResponsesSearchResponseArticleResult> articles = default(List<DtoResponsesSearchResponseArticleResult>), Object userInput = default(Object))
        {
            // to ensure "userInput" is required (not null)
            if (userInput == null)
            {
                throw new ArgumentNullException("userInput is a required property for DtoResponsesSearchResponseFailedSearchResponse and cannot be null");
            }
        ...
        public List<DtoResponsesSearchResponseArticleResult> Articles { get; set; }
        ...
        {
            return this.Equals(input as DtoResponsesSearchResponseFailedSearchResponse);
        }

        /// <summary>
        /// Returns true if DtoResponsesSearchResponseFailedSearchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DtoResponsesSearchResponseFailedSearchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DtoResponsesSearchResponseFailedSearchResponse input)
        {
            if (input == null)
            {
                return false;
