...
public class CountriesProperty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(CountriesProperty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CountriesProperty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CountriesProperty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<CountriesProperty>() {
                @Override
                public void write(JsonWriter out, CountriesProperty value) throws IOException {
                ...
                @Override
                public CountriesProperty read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        CountriesProperty ret = new CountriesProperty();
                    ...
                    throw new IOException(String.format("Failed deserialization for CountriesProperty: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public CountriesProperty() {
        super("anyOf", Boolean.FALSE);
    }

    public CountriesProperty(List<String> o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public CountriesProperty(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return CountriesProperty.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CountriesProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for CountriesProperty with anyOf schemas: List<String>, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of CountriesProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CountriesProperty
  * @throws IOException if the JSON string is invalid with respect to CountriesProperty
  */
  public static CountriesProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CountriesProperty.class);
  }

 /**
  * Convert an instance of CountriesProperty to an JSON string
  *
  * @return JSON string
  */
