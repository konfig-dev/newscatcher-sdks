...
public class CSLHFResponse {
  ...
  public CSLHFResponse() {
  }

  public CSLHFResponse status(String status) {
  ...
  **/
  ...
  public CSLHFResponse totalHits(Integer totalHits) {
  ...
  **/
  ...
  public CSLHFResponse page(Integer page) {
  ...
  **/
  ...
  public CSLHFResponse totalPages(Integer totalPages) {
  ...
  **/
  ...
  public CSLHFResponse pageSize(Integer pageSize) {
  ...
  **/
  ...
  public CSLHFResponse clustersCount(Integer clustersCount) {
  ...
  **/
  ...
  public CSLHFResponse clusters(List<Cluster1> clusters) {
  ...
  public CSLHFResponse addClustersItem(Cluster1 clustersItem) {
  ...
  **/
  ...
  public CSLHFResponse userInput(Object userInput) {
  ...
  **/
  ...
  public CSLHFResponse articles(List<ArticlesPropertyInner> articles) {
  ...
  public CSLHFResponse addArticlesItem(ArticlesPropertyInner articlesItem) {
  ...
  **/
   ...
   * @return the CSLHFResponse instance itself
   */
  public CSLHFResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CSLHFResponse csLHFResponse = (CSLHFResponse) o;
    return Objects.equals(this.status, csLHFResponse.status) &&
        Objects.equals(this.totalHits, csLHFResponse.totalHits) &&
        Objects.equals(this.page, csLHFResponse.page) &&
        Objects.equals(this.totalPages, csLHFResponse.totalPages) &&
        Objects.equals(this.pageSize, csLHFResponse.pageSize) &&
        Objects.equals(this.clustersCount, csLHFResponse.clustersCount) &&
        Objects.equals(this.clusters, csLHFResponse.clusters) &&
        Objects.equals(this.userInput, csLHFResponse.userInput) &&
        Objects.equals(this.articles, csLHFResponse.articles)&&
        Objects.equals(this.additionalProperties, csLHFResponse.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CSLHFResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CSLHFResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CSLHFResponse is not found in the empty JSON string", CSLHFResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CSLHFResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CSLHFResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CSLHFResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CSLHFResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CSLHFResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CSLHFResponse>() {
           @Override
           public void write(JsonWriter out, CSLHFResponse value) throws IOException {
           ...
           @Override
           public CSLHFResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CSLHFResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CSLHFResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CSLHFResponse
  * @throws IOException if the JSON string is invalid with respect to CSLHFResponse
  */
  public static CSLHFResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CSLHFResponse.class);
  }

 /**
  * Convert an instance of CSLHFResponse to an JSON string
  *
  * @return JSON string
  */
