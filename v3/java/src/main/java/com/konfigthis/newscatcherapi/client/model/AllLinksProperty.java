...
public class AllLinksProperty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AllLinksProperty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AllLinksProperty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AllLinksProperty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AllLinksProperty>() {
                @Override
                public void write(JsonWriter out, AllLinksProperty value) throws IOException {
                ...
                @Override
                public AllLinksProperty read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AllLinksProperty ret = new AllLinksProperty();
                    ...
                    throw new IOException(String.format("Failed deserialization for AllLinksProperty: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AllLinksProperty() {
        super("anyOf", Boolean.FALSE);
    }

    public AllLinksProperty(List<String> o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AllLinksProperty(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return AllLinksProperty.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AllLinksProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for AllLinksProperty with anyOf schemas: List<String>, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of AllLinksProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AllLinksProperty
  * @throws IOException if the JSON string is invalid with respect to AllLinksProperty
  */
  public static AllLinksProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AllLinksProperty.class);
  }

 /**
  * Convert an instance of AllLinksProperty to an JSON string
  *
  * @return JSON string
  */
