...
public class To extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<To>() {
                ...
                public void write(JsonWriter out, To value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: OffsetDateTime, String");
                }
                ...
                public To read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        To ret = new To();
                        ret.setActualInstance(adapterOffsetDateTime.fromJsonTree(jsonObject));
                        return ret;
                    } catch (Exception e) {
                    ...
                    throw new IOException(String.format("Failed deserialization for To: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to To
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for To with anyOf schemas: OffsetDateTime, String. JSON: %s", jsonObj.toString()));
    }
  }
