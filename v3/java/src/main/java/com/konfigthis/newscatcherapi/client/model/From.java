...
public class From extends AbstractOpenApiSchema {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<From>() {
                ...
                public From read(JsonReader in) throws IOException {
                    ...
                    throw new IOException(String.format("Failed deserialization for From: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public From(OffsetDateTime o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public From(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for From with anyOf schemas: OffsetDateTime, String. JSON: %s", jsonObj.toString()));
    }
  }
