...
public class AuthorsProperty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(AuthorsProperty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AuthorsProperty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AuthorsProperty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AuthorsProperty>() {
                @Override
                public void write(JsonWriter out, AuthorsProperty value) throws IOException {
                ...
                @Override
                public AuthorsProperty read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        AuthorsProperty ret = new AuthorsProperty();
                    ...
                    throw new IOException(String.format("Failed deserialization for AuthorsProperty: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AuthorsProperty() {
        super("anyOf", Boolean.FALSE);
    }

    public AuthorsProperty(List<String> o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public AuthorsProperty(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return AuthorsProperty.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuthorsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for AuthorsProperty with anyOf schemas: List<String>, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of AuthorsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthorsProperty
  * @throws IOException if the JSON string is invalid with respect to AuthorsProperty
  */
  public static AuthorsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorsProperty.class);
  }

 /**
  * Convert an instance of AuthorsProperty to an JSON string
  *
  * @return JSON string
  */
