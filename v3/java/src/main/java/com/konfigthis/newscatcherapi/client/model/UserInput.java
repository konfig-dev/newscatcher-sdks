...
public class UserInput {
  ...
  **/
   ...
   * @return the UserInput instance itself
   */
  public UserInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lang, userInput.lang) &&
        Objects.equals(this.countries, userInput.countries)&&
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserInput>() {
           ...
           public UserInput read(JsonReader in) throws IOException {
             ...
             UserInput instance = thisAdapter.fromJsonTree(jsonObj);
