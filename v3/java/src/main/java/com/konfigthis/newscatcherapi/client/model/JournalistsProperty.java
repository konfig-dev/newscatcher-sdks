...
public class JournalistsProperty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(JournalistsProperty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!JournalistsProperty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'JournalistsProperty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<JournalistsProperty>() {
                @Override
                public void write(JsonWriter out, JournalistsProperty value) throws IOException {
                ...
                @Override
                public JournalistsProperty read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        JournalistsProperty ret = new JournalistsProperty();
                    ...
                    throw new IOException(String.format("Failed deserialization for JournalistsProperty: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public JournalistsProperty() {
        super("anyOf", Boolean.FALSE);
    }

    public JournalistsProperty(List<String> o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public JournalistsProperty(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return JournalistsProperty.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to JournalistsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for JournalistsProperty with anyOf schemas: List<String>, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of JournalistsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JournalistsProperty
  * @throws IOException if the JSON string is invalid with respect to JournalistsProperty
  */
  public static JournalistsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JournalistsProperty.class);
  }

 /**
  * Convert an instance of JournalistsProperty to an JSON string
  *
  * @return JSON string
  */
