...
public class SearchSimilarGetResponse extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SearchSimilarGetResponse.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SearchSimilarGetResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SearchSimilarGetResponse' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SearchSimilarGetResponse>() {
                @Override
                public void write(JsonWriter out, SearchSimilarGetResponse value) throws IOException {
                ...
                @Override
                public SearchSimilarGetResponse read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        SearchSimilarGetResponse ret = new SearchSimilarGetResponse();
                    ...
                    throw new IOException(String.format("Failed deserialization for SearchSimilarGetResponse: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SearchSimilarGetResponse(DtoResponsesMoreLikeThisResponseFailedSearchResponse o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public SearchSimilarGetResponse(DtoResponsesMoreLikeThisResponseSearchResponse o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, GenericType> getSchemas() {
        return SearchSimilarGetResponse.schemas;
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchSimilarGetResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for SearchSimilarGetResponse with anyOf schemas: DtoResponsesMoreLikeThisResponseFailedSearchResponse, DtoResponsesMoreLikeThisResponseSearchResponse. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of SearchSimilarGetResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchSimilarGetResponse
  * @throws IOException if the JSON string is invalid with respect to SearchSimilarGetResponse
  */
  public static SearchSimilarGetResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchSimilarGetResponse.class);
  }

 /**
  * Convert an instance of SearchSimilarGetResponse to an JSON string
  *
  * @return JSON string
  */
