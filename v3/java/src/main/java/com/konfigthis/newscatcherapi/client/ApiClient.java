...
import com.konfigthis.newscatcherapi.client.auth.Authentication;
import com.konfigthis.newscatcherapi.client.auth.HttpBasicAuth;
import com.konfigthis.newscatcherapi.client.auth.HttpBearerAuth;
...
public class ApiClient extends ApiClientCustom {
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("apiKey", new ApiKeyAuth("header", "x-api-token"));
        ...
        if (configuration != null) {
            if (configuration.x-api-token != null) {
                this.setApiKey(configuration.x-api-token);
            }
     ...
     * @return a {@link com.konfigthis.newscatcherapi.client.ApiClient} object
     */
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.konfigthis.newscatcherapi.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to serialize the request body object
     */
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.konfigthis.newscatcherapi.client.ApiException If fail to serialize the request body object into a string
     */
