...
public class LangProperty extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(LangProperty.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LangProperty.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LangProperty' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<LangProperty>() {
                @Override
                public void write(JsonWriter out, LangProperty value) throws IOException {
                ...
                @Override
                public LangProperty read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        LangProperty ret = new LangProperty();
                    ...
                    throw new IOException(String.format("Failed deserialization for LangProperty: no class matched. JSON: %s", jsonObject.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public LangProperty(List<String> o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }

    public LangProperty(String o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LangProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
    ...
    if (validCount == 0) {
      throw new IOException(String.format("The JSON string is invalid for LangProperty with anyOf schemas: List<String>, String. JSON: %s", jsonObj.toString()));
    }
  }

 /**
  * Create an instance of LangProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LangProperty
  * @throws IOException if the JSON string is invalid with respect to LangProperty
  */
  public static LangProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LangProperty.class);
  }

 /**
  * Convert an instance of LangProperty to an JSON string
  *
  * @return JSON string
  */
