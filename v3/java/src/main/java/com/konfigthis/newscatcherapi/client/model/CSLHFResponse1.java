...
public class CSLHFResponse1 {
  ...
  public CSLHFResponse1() {
  }

  public CSLHFResponse1 status(String status) {
  ...
  **/
  ...
  public CSLHFResponse1 totalHits(Integer totalHits) {
  ...
  **/
  ...
  public CSLHFResponse1 page(Integer page) {
  ...
  **/
  ...
  public CSLHFResponse1 totalPages(Integer totalPages) {
  ...
  **/
  ...
  public CSLHFResponse1 pageSize(Integer pageSize) {
  ...
  **/
  ...
  public CSLHFResponse1 clustersCount(Integer clustersCount) {
  ...
  **/
  ...
  public CSLHFResponse1 clusters(List<Cluster1> clusters) {
  ...
  public CSLHFResponse1 addClustersItem(Cluster1 clustersItem) {
  ...
  **/
  ...
  public CSLHFResponse1 userInput(Object userInput) {
  ...
  **/
  ...
  public CSLHFResponse1 articles(List<ArticlesPropertyInner> articles) {
  ...
  public CSLHFResponse1 addArticlesItem(ArticlesPropertyInner articlesItem) {
  ...
  **/
   ...
   * @return the CSLHFResponse1 instance itself
   */
  public CSLHFResponse1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CSLHFResponse1 csLHFResponse1 = (CSLHFResponse1) o;
    return Objects.equals(this.status, csLHFResponse1.status) &&
        Objects.equals(this.totalHits, csLHFResponse1.totalHits) &&
        Objects.equals(this.page, csLHFResponse1.page) &&
        Objects.equals(this.totalPages, csLHFResponse1.totalPages) &&
        Objects.equals(this.pageSize, csLHFResponse1.pageSize) &&
        Objects.equals(this.clustersCount, csLHFResponse1.clustersCount) &&
        Objects.equals(this.clusters, csLHFResponse1.clusters) &&
        Objects.equals(this.userInput, csLHFResponse1.userInput) &&
        Objects.equals(this.articles, csLHFResponse1.articles)&&
        Objects.equals(this.additionalProperties, csLHFResponse1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CSLHFResponse1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CSLHFResponse1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CSLHFResponse1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CSLHFResponse1 is not found in the empty JSON string", CSLHFResponse1.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CSLHFResponse1.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CSLHFResponse1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CSLHFResponse1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CSLHFResponse1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CSLHFResponse1.class));

       return (TypeAdapter<T>) new TypeAdapter<CSLHFResponse1>() {
           @Override
           public void write(JsonWriter out, CSLHFResponse1 value) throws IOException {
           ...
           @Override
           public CSLHFResponse1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CSLHFResponse1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CSLHFResponse1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CSLHFResponse1
  * @throws IOException if the JSON string is invalid with respect to CSLHFResponse1
  */
  public static CSLHFResponse1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CSLHFResponse1.class);
  }

 /**
  * Convert an instance of CSLHFResponse1 to an JSON string
  *
  * @return JSON string
  */
