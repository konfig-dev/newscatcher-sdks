...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.10-blue)](https://central.sonatype.com/artifact/com.konfigthis.newscatcherapi/newscatcherapi-java-sdk/6.0.10)
...
dependencies {
   implementation "com.konfigthis.newscatcherapi:newscatcherapi-java-sdk:6.0.10"
}
```
...
* `target/newscatcherapi-java-sdk-6.0.10.jar`
* `target/lib/*.jar`
