...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.11-blue)](https://central.sonatype.com/artifact/com.konfigthis.newscatcherapi/newscatcherapi-java-sdk/6.0.11)
...
dependencies {
   implementation "com.konfigthis.newscatcherapi:newscatcherapi-java-sdk:6.0.11"
}
```
...
* `target/newscatcherapi-java-sdk-6.0.11.jar`
* `target/lib/*.jar`
