...
[![Maven Central](https://img.shields.io/badge/Maven%20Central-v6.0.7-blue)](https://central.sonatype.com/artifact/com.konfigthis.newscatcherapi/newscatcherapi-java-sdk/6.0.7)
...
dependencies {
   implementation "com.konfigthis.newscatcherapi:newscatcherapi-java-sdk:6.0.7"
}
```
...
* `target/newscatcherapi-java-sdk-6.0.7.jar`
* `target/lib/*.jar`
