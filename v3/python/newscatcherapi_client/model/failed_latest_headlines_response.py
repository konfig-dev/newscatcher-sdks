...
class FailedLatestHeadlinesResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class articles(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['DtoResponsesLatestHeadlinesResponseArticleResult']:
                        return DtoResponsesLatestHeadlinesResponseArticleResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['DtoResponsesLatestHeadlinesResponseArticleResult'], typing.List['DtoResponsesLatestHeadlinesResponseArticleResult']],
                ...
                def __getitem__(self, i: int) -> 'DtoResponsesLatestHeadlinesResponseArticleResult':
