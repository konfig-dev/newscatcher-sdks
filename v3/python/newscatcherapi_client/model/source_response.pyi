...
class SourceResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def user_input() -> typing.Type['UserInput']:
                return UserInput
            __annotations__ = {
                "message": message,
                "sources": sources,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["user_input"]) -> 'UserInput': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["user_input"]) -> 'UserInput': ...
