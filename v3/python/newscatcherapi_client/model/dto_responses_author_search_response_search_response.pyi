...
class DtoResponsesAuthorSearchResponseSearchResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def articles() -> typing.Type['DtoResponsesAuthorSearchResponseSearchResponseArticles']:
                return DtoResponsesAuthorSearchResponseSearchResponseArticles
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["articles"]) -> 'DtoResponsesAuthorSearchResponseSearchResponseArticles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["articles"]) -> 'DtoResponsesAuthorSearchResponseSearchResponseArticles': ...
