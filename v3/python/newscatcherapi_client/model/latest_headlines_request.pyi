...
class LatestHeadlinesRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["when", "by_parse_date", "lang", "not_lang", "countries", "not_countries", "sources", "predefined_sources", "not_sources", "ranked_only", "is_headline", "is_paid_content", "parent_url", "theme", "all_links", "all_domain_links", "word_count_min", "word_count_max", "page", "page_size", "clustering_enabled", "clustering_threshold", "clustering_variable", "include_nlp_data", "has_nlp", "ORG_entity_name", "PER_entity_name", "LOC_entity_name", "MISC_entity_name", "title_sentiment_min", "title_sentiment_max", "content_sentiment_min", "content_sentiment_max", ], str]):
