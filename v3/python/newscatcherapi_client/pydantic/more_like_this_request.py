...
class MoreLikeThisRequest(BaseModel):
    ...
    include_similar_documents: bool = Field(None, alias='include_similar_documents')

    similar_documents_number: int = Field(None, alias='similar_documents_number')

    similar_documents_fields: str = Field(None, alias='similar_documents_fields')
