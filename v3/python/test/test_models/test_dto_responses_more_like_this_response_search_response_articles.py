...
class TestDtoResponsesMoreLikeThisResponseSearchResponseArticles(unittest.TestCase):
    """DtoResponsesMoreLikeThisResponseSearchResponseArticles unit test stubs"""
    pass
