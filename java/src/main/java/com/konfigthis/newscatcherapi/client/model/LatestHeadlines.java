...
public class LatestHeadlines {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(when, lang, countries, notCountries, topic, sources, notSources, rankedOnly, sortBy, pageSize, page);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!LatestHeadlines.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LatestHeadlines` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
