...
public class ArticleInner {
  ...
  **/
   ...
   * @return the ArticleInner instance itself
   */
  public ArticleInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, articleInner.title) &&
        ...
        Objects.equals(this.additionalProperties, articleInner.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, author, publishedDate, publishedDatePrecision, link, cleanUrl, excerpt, summary, rights, rank, topic, country, language, authors, isOpinion, twitterAccount, score, id, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ArticleInner>() {
           ...
           public ArticleInner read(JsonReader in) throws IOException {
             ...
             ArticleInner instance = thisAdapter.fromJsonTree(jsonObj);
