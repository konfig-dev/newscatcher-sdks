...
public class Search {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(q, lang, notLang, publishedDatePrecision, from, to, searchIn, countries, notCountries, topic, sources, notSources, rankedOnly, sortBy, pageSize, page);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Search.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Search` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
