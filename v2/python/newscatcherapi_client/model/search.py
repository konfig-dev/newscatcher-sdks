...
class Search(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["q", "lang", "not_lang", "published_date_precision", "from", "to", "search_in", "countries", "not_countries", "topic", "sources", "not_sources", "ranked_only", "from_rank", "to_rank", "sort_by", "page_size", "page", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["q", "lang", "not_lang", "published_date_precision", "from", "to", "search_in", "countries", "not_countries", "topic", "sources", "not_sources", "ranked_only", "from_rank", "to_rank", "sort_by", "page_size", "page", ], str]):
