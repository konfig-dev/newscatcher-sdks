...
namespace Newscatcherapi.Net.Model
{
    ...
    /// LatestHeadlines
    /// </summary>
    [DataContract(Name = "latestHeadlines")]
    public partial class LatestHeadlines : IEquatable<LatestHeadlines>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LatestHeadlines" /> class.
        /// </summary>
        /// <param name="when">The time period you want to get the headlines for. Accpeted format: - &#x60;7d&#x60; -&gt; Daily form, last 7 days time period - &#x60;6h&#x60; -&gt; Hourly form, last six hours .</param>
        ...
        public LatestHeadlines(string when = default(string), LangEnum? lang = default(LangEnum?), string countries = default(string), string notCountries = default(string), TopicEnum? topic = default(TopicEnum?), string sources = default(string), string notSources = default(string), bool rankedOnly = default(bool), int pageSize = default(int), int page = default(int))
        {
            this.When = when;
            this.Lang = lang;
        ...
        /// </summary>
        /// <value>The time period you want to get the headlines for. Accpeted format: - &#x60;7d&#x60; -&gt; Daily form, last 7 days time period - &#x60;6h&#x60; -&gt; Hourly form, last six hours </value>
        ...
        {
            return this.Equals(input as LatestHeadlines);
        }

        /// <summary>
        /// Returns true if LatestHeadlines instances are equal
        /// </summary>
        /// <param name="input">Instance of LatestHeadlines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LatestHeadlines input)
        {
            if (input == null)
            {
                return false;
