...
public class SourcesQuery {
  ...
  **/
   ...
   * @return the SourcesQuery instance itself
   */
  public SourcesQuery putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.lang, sourcesQuery.lang) &&
        ...
        Objects.equals(this.additionalProperties, sourcesQuery.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SourcesQuery>() {
           ...
           public SourcesQuery read(JsonReader in) throws IOException {
             ...
             SourcesQuery instance = thisAdapter.fromJsonTree(jsonObj);
