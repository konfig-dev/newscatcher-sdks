...
# body param
SchemaForRequestBodyApplicationJson = LatestHeadlines


request_body_latest_headlines = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_latest_headlines.serialize(body, content_type)
