...
class SearchIn(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """SearchIn - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str):, must be one of ["title", "summary", "title_summary", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["title", "summary", "title_summary", ]  # noqa: E501
