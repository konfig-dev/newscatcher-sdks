...
class SuccessStatus(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str):, must be one of ["ok", "No matches for your search.", ]  # noqa: E501

        Keyword Args:
            value (str):, must be one of ["ok", "No matches for your search.", ]  # noqa: E501
