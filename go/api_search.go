...
func (r ApiGetRequest) Q(q string) ApiGetRequest {
	r.q = &q
	return r
}
...
func (r ApiGetRequest) PublishedDatePrecision(publishedDatePrecision PublishDatePrecision) ApiGetRequest {
...
func (r ApiGetRequest) From(from string) ApiGetRequest {
	r.from = &from
	return r
}

// &#x60;YYYY/mm/dd&#x60; Until which point in time to search for. The default timezone is UTC. 
func (r ApiGetRequest) To(to string) ApiGetRequest {
	r.to = &to
	return r
}
...
func (r ApiGetRequest) SearchIn(searchIn SearchIn) ApiGetRequest {
	r.searchIn = &searchIn
	return r
}
...
func (r ApiGetRequest) FromRank(fromRank int32) ApiGetRequest {
	r.fromRank = &fromRank
	return r
}

// &#x60;[0:999999]&#x60; The upper boundary of the rank of a news website to filter by. 
func (r ApiGetRequest) ToRank(toRank int32) ApiGetRequest {
	r.toRank = &toRank
	return r
}
...
func (r ApiGetRequest) SortBy(sortBy SortBy) ApiGetRequest {
	r.sortBy = &sortBy
	return r
}
...
func (r ApiGetRequest) Execute() (*Model200Response, *http.Response, error) {
...
*/
func (a *SearchApiService) Get() ApiGetRequest {
	return ApiGetRequest{
		ApiService: a,
...
func (a *SearchApiService) GetExecute(r ApiGetRequest) (*Model200Response, *http.Response, error) {
	var (
...
func (r ApiPostRequest) Search(search Search) ApiPostRequest {
	r.search = &search
	return r
}

func (r ApiPostRequest) Execute() (*Model200Response, *http.Response, error) {
...
*/
func (a *SearchApiService) Post() ApiPostRequest {
	return ApiPostRequest{
		ApiService: a,
		ctx: a.client.cfg.Context,
	}
...
// Execute executes the request
//  @return Model200Response
func (a *SearchApiService) PostExecute(r ApiPostRequest) (*Model200Response, *http.Response, error) {
	var (
